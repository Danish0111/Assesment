    ...
    return (
        <>
            <div className="WhyChoose_container p-10">
                ...
                <div class="card bg-[#FEF3EF] flex flex-col justify-center items-center">
                ...
                <div class="card bg-[#F1FBF3] flex flex-col justify-center items-center">
                ...
                <div className=" lg:w-[65%] flex justify-self-end">
                    <div class="card w-[50%] bg-[#EDF3FF] flex flex-col justify-center items-center self-end">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card bg-[#FBF1FB] flex flex-col justify-center items-center">
                ...
                <div class="card bg-[#27AE600A] flex flex-col justify-center items-center">
                    <svg width="38" height="41" viewBox="0 0 38 41" fill="none" xmlns="http://www.w3.org/2000/svg">
