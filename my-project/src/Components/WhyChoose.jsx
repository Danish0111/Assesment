...
const WhyChoose = () => {
    return (
        <>
            <div className="WhyChoose_container p-10">
                <div className='w-[100%] lg:w-[40vw] pb-8'>
                    <div className="why text-[#EB8D15]">WHY REGISTERKARO.IN</div>
                ...
                <div className="card bg-[#FEF3EF] flex flex-col justify-center items-center">
                ...
                <div className="card bg-[#F1FBF3] flex flex-col justify-center items-center">
                ...
                <div className=" lg:w-[65%] flex justify-self-end">
                    <div className="card w-[50%] bg-[#EDF3FF] flex flex-col justify-center items-center self-end">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card bg-[#FBF1FB] flex flex-col justify-center items-center">
