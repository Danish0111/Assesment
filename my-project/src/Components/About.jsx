...
const About = () => {
    ...
    return (
        <>
            <div className="about_container relative lg:static  flex flex-col-reverse lg:flex-row justify-center items-center p-5 lg:px-16 py-16 gap-10">
                <div className="left w-[100%] lg:w-[50%]">
                    ...
                    <p className={`text-lg sm:text-xl ${isExpanded ? "" : "line-clamp-3 lg:line-clamp-none"}`}>We have been using Intelegencia as our DevOps vendor for our field service applications over the last couple of years and I’m extremely pleased with
                    ...
                    <button 
                        ...
                        className="text-[#EB8D15] mt-2 font-semibold"
                    >
                        Read More
                    </button>
                )}
